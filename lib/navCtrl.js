    ...
    app.controller('navCtrl', ['$scope','$log',
        function($scope,$log,$fnCtrl) {
            ...
            $scope.rotateRt = function() {
                ...
                angular.element('.selected span.h_rotation')
                    .parent().parent().find('span.h_rotation').html(rotation);
            ...
            $scope.export = function() {
                ...
                angular.forEach(elements,function(value,key){
                    ...
                    element.witdh = angular.element(value).width();
                    element.height = angular.element(value).height();
                    element.position = angular.element(value).position();
                    element.matrix = angular.element(value).css('transform');
                ...
                $log.debug(angular.toJson($scope.exportData,true));
